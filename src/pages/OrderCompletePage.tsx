...
export const OrderCompletePage: React.FC = () => {
  const { currentOrder, orders, setActivePage, setMyPageTab, openReceiptModal, subsidyLedger } = useShop();
    ...
    <div className='w-full bg-[#f6f6f6] py-10 min-h-screen text-[#3d3c3f]'>
      <div className='max-w-[840px] mx-auto px-4 space-y-6'>
        ...
        <div className='flex flex-wrap items-center justify-center gap-3 pt-4'>
          <button onClick={() => openReceiptModal(order)} className='px-6 py-3 rounded-lg border border-[#cbd2d4] bg-white hover:bg-[#f6f6f6] text-sm font-bold text-[#181718] flex items-center gap-2 transition-colors shadow-xs'>
          ...
          <button onClick={() => setActivePage('explore')} className='px-8 py-3 rounded-lg bg-[#df0000] hover:bg-[#ea2e2e] text-sm font-bold text-white flex items-center gap-2 transition-colors shadow-sm'>
