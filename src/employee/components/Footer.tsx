      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <div className="flex items-center gap-2 pt-2 text-[11px] font-medium text-gray-700">
        ...
        {/* 카피라이트 및 법적 고지 바 */}
        <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-3 text-[11px] text-gray-500">
