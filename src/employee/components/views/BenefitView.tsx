      ...
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-gray-200 pb-4'>
        <div>
          <h1 className='text-2xl font-black text-gray-900 tracking-tight flex items-center gap-2'>
            <span>나의 지원금</span>
            <span className='text-xs font-semibold bg-red-100 text-[#D7001E] px-2 py-0.5 rounded-full'>영풍문고 임직원 전용</span>
          </h1>
          ...
          <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4 text-xs text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-100'>
            <div>
              ...
              <p className='font-bold text-gray-800'>
                10,000원 <span className='font-normal text-gray-500'>(누적 사용 {benefitState.personalBook.usedAmount.toLocaleString()}원)</span>
              </p>
            </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 leading-relaxed'>
          <div className='space-y-3'>
            ...
            <div>
              ...
              <p className='text-gray-600 pl-2.5 mt-0.5'>주문서 작성 시 '개인 도서 지원금 50% 적용' 체크 시 보유 잔여 한도 내에서 자동 계산되며, 신용카드/적립금/간편결제와 복합결제가 가능합니다.</p>
            </div>
          </div>
          ...
          <div className='space-y-3'>
            ...
            <div>
              ...
              <p className='text-gray-600 pl-2.5 mt-0.5'>매 반기 말(6월 30일 / 12월 31일 23:59) 미사용 지원금 및 추천도서 지원 자격은 자동 소멸되며 다음 반기로 이월되지 않습니다.</p>
            </div>
          </div>
        </div>
