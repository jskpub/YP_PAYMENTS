...
export const RefundView: React.FC<RefundViewProps> = ({
  refundHistories,
  benefitState,
  setBenefitState,
  setActiveTab,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-200 pb-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            주문하신 상품의 취소/반품/환불 신청 및 처리 현황을 확인하실 수 있습니다.
          </p>
        </div>
        ...
        <button
          ...
          className={`py-2 px-3 border-b-2 cursor-pointer transition-colors ${
            activeSubTab === 'request'
              ? 'border-[#D7001E] text-[#D7001E] font-bold'
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-xs">
                <div className="bg-gray-50 px-4 py-2.5 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between text-xs gap-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-gray-600">주문번호 YP20260904-0193</span>
                  </div>
                  <span className="text-emerald-700 font-semibold bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 self-start sm:self-auto">
                    ✓ 배송완료 (반품 가능 기한: 2026.09.11까지)
                  </span>
                </div>
                  ...
                  <div className="flex items-start gap-3.5 flex-1">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-red-50 text-[#D7001E] border border-red-200">
                          개인도서 지원 5,000원 적용
                        </span>
                        <span className="text-[10px] text-gray-500 font-mono">
                          CJ대한통운 6849-2910-4491
                        </span>
                      </div>
                      ...
                      <div className="text-xs text-gray-700 pt-0.5">
                        ...
                        <span className="mx-1.5 text-gray-300">|</span>
                        <span>
                          실 결제금액: <strong className="text-gray-900">19,000원</strong>{' '}
                          <span className="text-[#D7001E] font-medium">
                            (임직원 개인 지원금 5,000원 공제 완료)
                          </span>
                        </span>
                      </div>
                    </div>
              ...
              <div id="refund-calc-section" className="bg-[#FAFBFD] border border-gray-300 rounded-xl p-5 shadow-xs space-y-4">
                <div className="border-b border-gray-200 pb-2">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    반품 사유를 선택하시면 지원금 환원 및 공제 배송비가 자동 산출됩니다.
                  </p>
                </div>
                  ...
                  <div className="space-y-3.5">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full p-2 border border-gray-300 rounded bg-white font-medium text-gray-800 focus:outline-none focus:ring-1 focus:ring-[#D7001E]"
                      >
                        <option value="change_mind">
                          단순 변심 (도서 미개봉/상태 양호) - 고객 부담 배송비 2,500원
                        </option>
                        <option value="defect">
                          도서 파본 / 오배송 / 파손 - 영풍문고 부담 무료 반품 (배송비 0원)
                        </option>
                      </select>
                    </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-2.5">
                    ...
                    <div className="flex justify-between items-center bg-emerald-50 px-2.5 py-1.5 rounded border border-emerald-200">
                      ...
                      <span className="font-black text-emerald-700">
                        +{benefitRestoreAmount.toLocaleString()}원 (한도로 즉시 반환!)
                      </span>
                    </div>
                    ...
                    <div className="pt-2 border-t border-gray-200 flex justify-between items-baseline">
                      ...
                      <span className="text-xl font-black text-[#D7001E]">
                        {estimatedRefundAmount.toLocaleString()}원
                      </span>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full mt-3 py-2.5 bg-[#D7001E] text-white font-bold rounded-md hover:bg-red-700 transition-colors shadow-xs cursor-pointer text-xs"
                    >
                      반품 및 지원금 복원 신청 확정
                    </button>
                  </div>
            ...
            <div className="bg-white border border-emerald-200 rounded-xl p-8 text-center space-y-3">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="px-4 py-2 bg-[#D7001E] text-white text-xs font-bold rounded hover:bg-red-700 cursor-pointer"
                >
                  나의 지원금 잔여 현황 확인하기
                </button>
              </div>
                ...
                {isSubmitted && (
                  <tr className="bg-red-50/30 text-center">
                    <td className="py-3 px-3 whitespace-nowrap">
                      ...
                      <p className="font-mono text-[10px] text-gray-400">RF20260915-0921</p>
                    </td>
                    ...
                    <td className="py-3 px-3 text-gray-600">
                      {reason === 'change_mind' ? '단순 변심' : '도서 하자/파본'}
                    </td>
                    ...
                    <td className="py-3 px-3 whitespace-nowrap text-amber-700 font-semibold text-[11px]">
                      수거 진행중
                    </td>
                    <td className="py-3 px-2">
                ...
                {refundHistories.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50 text-center">
                    <td className="py-3 px-3 whitespace-nowrap">
                      ...
                      <p className="font-mono text-[10px] text-gray-400">{item.receiptNumber}</p>
                    </td>
                    ...
                    <td className="py-3 px-3 text-gray-600 text-[11px] max-w-xs">
                      {item.reason}
                    </td>
                    ...
                    <td className="py-3 px-2 whitespace-nowrap">
                      <button
                        type="button"
                        onClick={() => alert(`[${item.receiptNumber}] ${item.type} 영수증/전표 출력 화면입니다.`)}
                        className="px-2 py-1 text-[11px] border border-gray-300 rounded hover:bg-gray-100 text-gray-700 cursor-pointer"
                      >
          ...
          <div className="space-y-3">
            <div>
              ...
              <ul className="text-gray-600 pl-3 list-disc space-y-1 mt-1 text-[11px]">
                <li><strong>출고 전/배송 준비 중:</strong> 고객센터 문의 없이 마이페이지에서 즉시 [주문취소] 가능하며 결제금액이 100% 즉시 환불됩니다.</li>
                <li><strong>배송 완료 후:</strong> 상품 수령일로부터 7일 이내에 반품/환불 신청이 가능합니다.</li>
                <li><strong>파손, 파본, 오배송의 경우:</strong> 수령 후 30일 이내 무상 반품/교환이 보장됩니다.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-gray-600 pl-3 list-disc space-y-1 mt-1 text-[11px]">
                <li><strong>고객 단순 변심 및 주문 착오:</strong> 왕복 배송비 5,000원(편도 2,500원)이 최종 환불금에서 차감됩니다.</li>
                <li><strong>도서 하자, 파본, 오배송:</strong> 반품 및 교환 배송비 전액 영풍문고 부담.</li>
                <li><strong>매장 직접 반품:</strong> 사전 접수 후 가까운 영풍문고 데스크에서 무상 반품 가능합니다.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="bg-red-50/50 p-3 rounded-lg border border-red-100">
              ...
              <ul className="text-gray-700 pl-3 list-disc space-y-1 mt-1 text-[11px]">
                <li><strong>추천도서 (100% 지원):</strong> 반품 승인 완료 즉시 당월 지원 횟수(권수) 및 한도가 100% 원상 복구됩니다.</li>
                <li><strong>개인도서 지원금:</strong> 결제 시 차감되었던 지원금 금액(최대 5,000원)이 <strong className="text-[#D7001E]">'나의 지원금' 잔여 한도로 즉시 재적립</strong>됩니다.</li>
            ...
            <div>
              ...
              <p className="text-gray-600 text-[11px] mt-1">
                신용/체크카드: 3~5 영업일 / 간편결제(카카오/네이버페이): 당일 또는 익영업일 즉시 복원 / 무통장: 1영업일 이내 계좌 입금
              </p>
            </div>
          </div>
        </div>
