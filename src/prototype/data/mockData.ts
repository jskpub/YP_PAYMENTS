...
const RECOMMENDED_BASE: BookBase[] = [
  {
    ...
    curationReason:
      '코드 리뷰와 페어 프로그래밍 문화를 고민하는 팀에게 이달의 1순위로 추천합니다. 저자는 혼자 잘하는 사람보다 함께 잘하는 팀을 만드는 방법을 학습 이론과 현장 경험을 엮어 설명합니다. 신입부터 시니어까지 눈높이에 맞춰 읽을 수 있고, 실제로 사내 스터디에서 여러 차례 언급된 책이기도 합니다. 협업과 성장의 관계를 다시 짚어보고 싶은 팀이라면 이번 달을 놓치지 마세요. 다음 정기 스터디 도서로도 이어갈 계획입니다.',
  ...
  },
  {
    ...
    curationReason:
      '연차와 무관하게 요즘 많은 분들이 공감하시는 주제라 이달 추천도서로 골랐습니다. 성과를 내야 한다는 압박과 쉬어야 한다는 죄책감 사이에서 흔들리는 마음을 담담한 문장으로 짚어 줍니다. 거창한 조언 대신 오늘 하루를 버티는 데 필요한 작은 루틴들을 제안하는 점이 특히 좋았습니다. 야근이 잦은 시기를 지나고 있는 팀이라면 더 깊이 와닿을 것 같습니다. 가볍게 읽히지만 오래 곱씹게 되는 책입니다.',
    recommender: null,
  ...
  },
  {
    ...
    curationReason:
      '부서 구분 없이 모두에게 권하고 싶은 이 시대의 필독 소설입니다. 담담한 문장으로 무거운 역사를 그려내면서도 읽는 이의 마음을 끝까지 붙잡는 힘이 있습니다. 이미 여러 임직원분들이 리뷰를 남겨주실 만큼 사내에서도 화제가 된 작품입니다. 한 번쯤 천천히 앉아 읽어보시길 권합니다. 올해 목록 중 문학 분야를 대표하는 도서로 선정했습니다.',
    recommender: null,
    recommenderNote: null,
    purchaseCount: 42,
    comments: [
  ...
  },
  {
    ...
    curationReason:
      '올해 신임 팀장이 많은 조직 특성을 고려해 인사팀 요청으로 선정했습니다. 처음 팀을 맡은 분들이 흔히 겪는 고민들을 사례 중심으로 풀어내 실무에 바로 적용하기 좋습니다. 피드백을 주고받는 법, 회의를 이끄는 법처럼 당장 필요한 기술을 다루고 있어 부담 없이 읽힙니다. 신임 팀장뿐 아니라 예비 리더급 구성원에게도 추천드립니다. 하반기 리더십 교육 과정과도 연계해 활용할 예정입니다.',
  ...
  },
  {
    ...
    curationReason:
      '매달 베스트셀러 상위권을 지키고 있는 화제작이라 소개합니다. 현실적이고 직설적인 조언이 호불호가 갈릴 수 있지만, 그만큼 오래 곱씹게 만드는 문장이 많습니다. 일과 돈, 인생을 대하는 태도에 대해 한 번쯤 스스로에게 질문을 던져보고 싶은 분들께 권합니다. 부서 상관없이 다양한 연차의 직원분들이 함께 읽고 이야기 나누기 좋은 책입니다. 사내 독서모임에서도 종종 언급되는 도서입니다.',
    recommender: null,
    recommenderNote: null,
    purchaseCount: 18,
    comments: [
  ...
  },
  {
    ...
    curationReason:
      '영업 전략 수립 시기에 맞춰 영업팀에서 직접 요청한 도서입니다. 오랜 기간 조직을 이끈 저자의 경험을 바탕으로 리더가 던져야 할 질문들을 정리해 실전에 바로 적용하기 좋습니다. 영업 조직뿐 아니라 전략을 고민하는 모든 팀에 도움이 될 내용입니다. 하반기 워크숍을 앞두고 팀원들과 함께 미리 읽어보시길 권합니다. 짧은 챕터로 구성돼 있어 바쁜 일정 중에도 부담 없이 읽을 수 있습니다.',
  ...
  },
  {
    ...
    curationReason:
      '연말 예산 시즌을 앞두고 재무팀 관리자 선정으로 이달 목록에 올렸습니다. 회계나 재무를 전공하지 않은 분들도 어렵지 않게 따라갈 수 있도록 실무 사례를 중심으로 설명합니다. 손익계산서를 읽는 법부터 예산을 짜는 감각까지, 비전공자에게 꼭 필요한 내용만 골라 담았습니다. 재무팀이 아니더라도 숫자를 다뤄야 하는 모든 직군에 권할 만한 책입니다. 연말 결산 업무에 앞서 미리 읽어두시면 도움이 될 것입니다.',
    recommender: null,
    recommenderNote: null,
    purchaseCount: 4,
    comments: [],
  },
  {
    ...
    curationReason:
      '장르 편식 없이 다양한 책을 만나셨으면 하는 마음으로 골랐습니다. 한 과학자의 집요한 삶을 따라가다 보면 어느새 전혀 다른 이야기로 이어지는 전개가 인상적입니다. 과학책이라기보다 한 편의 논픽션 서사처럼 읽혀서 과학에 익숙하지 않은 분들도 부담 없이 즐길 수 있습니다. 결말의 반전 덕분에 다 읽고 나서 다시 앞으로 돌아가게 되는 책입니다. 생각이 많아지는 밤, 천천히 읽어보시길 권합니다.',
    recommender: null,
    recommenderNote: null,
    purchaseCount: 15,
    comments: [
  ...
  },
  {
    ...
    curationReason:
      '보고서든 기획서든 결국 글이라, 부서 구분 없이 요청이 많았던 책입니다. 완벽한 첫 문장 대신 엉망인 초고부터 써보라는 저자의 조언이 실제 업무 글쓰기에도 그대로 적용됩니다. 글쓰기 강박을 조금 내려놓고 싶은 분들께 특히 권해드립니다. 가벼운 유머와 함께 실용적인 팁을 담고 있어 끝까지 즐겁게 읽힙니다. 이메일 한 통 쓰는 것도 부담스러운 날, 펼쳐보시길 추천합니다.',
    recommender: null,
    recommenderNote: null,
    purchaseCount: 11,
    comments: [
  ...
  },
  {
    ...
    curationReason:
      '가볍게 읽기 좋으면서도 여운이 남는 책이라 이달 목록에 더했습니다. 일상에서 스쳐 지나가는 순간들을 붙잡아 담담한 문장으로 풀어낸 짧은 에세이 모음입니다. 순서 없이 아무 페이지나 펼쳐 읽어도 좋아 바쁜 업무 중 틈틈이 읽기에 알맞습니다. 말과 글에 담긴 무게를 한 번쯤 돌아보고 싶은 분들께 권합니다. 출퇴근길에 가볍게 들고 다니기 좋은 분량입니다.',
    recommender: null,
    recommenderNote: null,
    purchaseCount: 27,
    comments: [],
